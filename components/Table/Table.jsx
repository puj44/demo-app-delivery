                        ...
                        return(
                            <tr key={idx}>
                                {formData?.length && formData?.map((fD,i)=>{
                                    return(
                                        <td className={`py-2 pe-1 ${fD?.customClass ?? ""}`} style={fD?.customStyle?fD?.customStyle(rowValue):{}} key={fD.field+idx+i}>{fD?.customField ? fD?.customField(rowValue,fD,idx,tableData):rowValue?.[fD?.field]}</td>
                                    )
                                })}
                            </tr>
                        )
